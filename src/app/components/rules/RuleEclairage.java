...
public class RuleEclairage implements RuleI {
	...
	public static final EventMatcherI MATCHER_PRESENCE_DETECTION =
			(e -> e.getPropertyValue("type").equals("presence detection")) ;
	
	public static final EventMatcherI MATCHER_LIGHT_ON_DETECTION =
			(e -> e.getPropertyValue("type").equals("light on detection")) ;
	...
	public ArrayList<EventI> trigger() {
		...
		if (lightOn != null && presence==null) {
			//lumiere allumé et aucune présence
